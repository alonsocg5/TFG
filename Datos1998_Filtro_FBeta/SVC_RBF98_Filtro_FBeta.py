...
svc_rbf = SVC(kernel='rbf', random_state=1234, class_weight = None)
...
grid_search = GridSearchCV(svc_rbf, param_grid, cv=folds5, scoring = fbeta_scorer, verbose=1, n_jobs=-1)
