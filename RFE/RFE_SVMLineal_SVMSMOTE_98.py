...
# Grid para la búsqueda de hiperparámetros
param_grid_rf = {
    'modelo__n_estimators': [25, 50, 100],          # Número de árboles
    'modelo__max_depth': range(3, 15),              # Profundidad máxima de los árboles
    'modelo__min_samples_split': [2, 3, 5, 8 ,10],  # Mínimo número de muestras para dividir un nodo
}
...
for i in range(len(columnas_ordenadas), 0, -1):
    ...
    pipeline = Pipeline([
        ...
        #("modelo", RandomForestClassifier(random_state=1234, class_weight = None)),
