...
# Creamos el Random Forest (class_weight ---> None / balanced)
rf = RandomForestClassifier(random_state=1234, class_weight = None)
...
pipeline = Pipeline([
    ("oversampling", ADASYN(sampling_strategy = 0.7, random_state=42)),
...
importances = best_model.named_steps['modelo'].feature_importances_
(num_ejemplos, num_atributos) = X.shape
indices = np.argsort(importances)[::-1]
fig, ax = plt.subplots()
fig.set_size_inches((16,12))
ax.set_title("Relevancia de los atributos - 1998")
