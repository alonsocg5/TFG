...
# Creamos el pipeline con el estandarizador y el sistema (class_weight ---> None / balanced)
log_reg = Pipeline([('std', StandardScaler()), 
                    ('lr', LogisticRegression(random_state=1234, max_iter=700, class_weight = None))])

# Grid para la búsqueda de hiperparámetros
param_grid = {
    'modelo__lr__C':  np.logspace(1, 4, 10)     # de 10^1 (10) a 10^4 (10000), 10 valores
}
